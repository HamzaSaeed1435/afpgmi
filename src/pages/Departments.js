  ...
  const departmentsData = [
    {
      ...
      data: [
        ...
        {
          coursesOffered: "Mid Career Course (MCC)",
          duration: "12 Weeks",
          freq: "Thrice a year",
          type: "Degree(NUMS)",
        },
        {
          coursesOffered: "Senior Army Dental Officers Course ",
          duration: "16 Weeks",
          freq: "Once an year",
          type: "Certificate(NUMS)",
        },
        {
          coursesOffered:
            "Professional Development Courses for Junior Officers",
          duration: "02  Weeks",
          freq: "Once in two months",
          type: "Certificate(NUMS)",
        },
        {
          coursesOffered: "Sports Medicine Course",
          duration: "12  Weeks",
          freq: "As & when required",
          type: "Certificate(NUMS)",
        },
        {
          coursesOffered: "Disaster MGMT Course",
          duration: "12  Weeks",
          freq: "As & when required",
          type: "Certificate(NUMS)",
        },
    ...
    },
    {
      ...
      data: [
        {
          coursesOffered: "MCPS/ FCPS-II",
          duration: "3 - 4 years",
          freq: "Twice a year",
          type: "Degree (CPSP)",
        },
        {
          coursesOffered: "BS Program (MLT, MIT, CPT)",
          duration: "4 years",
          freq: "Once an year",
          type: "Degree (NUMS)",
        },
        {
          coursesOffered: "MSc in Cardiac Anaesthesia",
          duration: "-",
          freq: "Once an year",
          type: "Degree (NUMS)",
        },
        {
          coursesOffered: "MS in Transfusion Medicine",
          duration: "-",
          freq: "Once an year",
          type: "Degree (NUMS)",
        },
        {
          coursesOffered: "PhD Pathology",
          duration: "-",
          freq: "Once an year",
          type: "Degree (NUMS)",
        },
        ...
        {
          coursesOffered:
            "Clinical Fellowship in Otology & Audio-Vestibular Rehabilitation",
          duration: "-",
          freq: "Once an year",
          type: "Degree (NUMS)",
        },
        {
          coursesOffered: "M Phil (Chemical & Oral Pathology, Microbiology) ",
          duration: "-",
          freq: "Once an year",
          type: "Certificate (NUMS)",
        },
        {
          coursesOffered: "Diploma in Cardiology",
          duration: "-",
          freq: "Once an year",
          type: "Diploma (NUMS)",
        },
    ...
    {
      name: "DEPARTMENT OF SCIENCE IN PUBLIC HEALTH (MSPH)",
      image: DepartmentsHeroImg3,
      data: [
        { name: "Started at AFPGMI from 2001 with UHS" },
        { name: "Affiliated with NUMS in 2016" },
        { name: "Presently - 2 batches undergoing training" },
        {
          name: "Intensive Curriculum includes",
          subData: [
            "Basic Public Health Sciences",
            "Essential Managerial and Analytical Skills including Project Planning and Evaluation",
    ...
    },
    {
      ...
      data: [
        { name: "78 x Exams conducted every year" },
        { name: "6 x Global Centres" },
        { name: "12 x National Centres" },
      ],
    },
